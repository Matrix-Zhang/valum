...
namespace VSGI.SCGI {
	...
	public class Request : CGI.Request {
		...
		private BoundedInputStream _body;
		 ...
		 */
		public Request (IOStream connection, BoundedInputStream reader, string[] environment) {
		...
		public override int command_line (ApplicationCommandLine command_line) {
			...
			listener.incoming.connect ((connection) => {
				...
				try {
					...
					var req = new Request (connection, new BoundedInputStream (reader, content_length), environment);
